<template>
  <div
    class="card card-flush d-flex flex-column justify-space-between h-100"
    :class="className"
  >
    <!--begin::Header-->
      ...
      <div class="card-title d-flex flex-column">
        ...
        <div class="d-flex align-items-center">
          ...
          <span class="fs-2hx fw-bold text-dark me-2 lh-1 ls-n2">
            ...
            <span class="fw-bold text-dark">USDT</span>
          </span>
          <!--end::Amount-->
        </div>
        <!--end::Info-->
    ...
    <!--begin::Card body-->
    <div
      class="card-body pt-2 pb-4 d-flex flex-wrap align-items-center justify-content-around"
    >
      <!--begin::Chart-->
      ...
      >
        ...
        >
          <div class="d-flex align-items-center">
            ...
            <!--end::Bullet-->
            <!--begin::Label-->
            <div class="text-gray-500 fw-bold fs-6 flex-grow-1 me-4">
              {{ $t("Available.fiat") }}
            </div>
            <!--end::Label-->
          </div>
          <!--begin::Stats-->
          <div class="number-apex fw-bold fs-6 text-xxl-end">
            ${{ numberFormatting(totalFiat) }}
          </div>
          <!--end::Stats-->
        </div>
        <!--end::Label-->
        ...
        >
          <div class="d-flex align-items-center">
            <!--begin::Bullet-->
            <div
              class="bullet w-20px h-3px rounded-2 me-3"
          ...
          <!--begin::Stats-->
          <div class="number-apex fw-bold fs-6 text-xxl-end">
            ${{ numberFormatting(totalStableCoin) }}
          </div>
          <!--end::Stats-->
        </div>
        <!--end::Label-->
...
export default defineComponent({
  ...
  computed: {
    ...
    totalStableCoin() {
      let total = 0;
      let arrayCrypto = this.store.wallet.filter(
        (item) => !item["isFiat"] && item["isStableCoin"]
      );
      arrayCrypto.forEach((item) => {
        total += (item["balance"] + item["frozenBalance"]) * item["usdRate"];
      });
