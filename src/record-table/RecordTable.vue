...
import TableContent from "@/components/record-table/table-partials/table-content/TableContent.vue";
import TableFooter from "@/components/record-table/table-partials/TableFooter.vue";
import type { Sort } from "@/components/record-table/table-partials/models";
...
export default defineComponent({
  ...
  props: {
    ...
    emptyTableText: { type: String, required: false, default: "Нет доступной информации" },
